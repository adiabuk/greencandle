...
if [[ ! -f /usr/local/bin/gechodriver ]]; then
    curl -L https://www.dropbox.com/sh/l22jyonei087h4o/AAAVa_B_sDXtWZu17RzazsA2a/geckodriver-v0.26.0-linux64.tar.gz?dl=0 -o /tmp/geckodriver-v0.26.0-linux64.tar.gz
