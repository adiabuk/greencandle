        ...
        stage("build docker images") {
            steps {
                ...
                ansiColor('vga') {
                     ...
                     sh 'docker-compose -f install/docker-compose_jenkins.yml -p $BUILD_ID build --pull --build-arg BRANCH=$GIT_BRANCH --build-arg COMMIT=$SHORT_COMMIT --build-arg DATE="$(date)"'
